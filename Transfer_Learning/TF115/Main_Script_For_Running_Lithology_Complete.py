...
if args.phase == 'train':
    ...
    CSV_FILES_NAMES_TRAIN = ['OTUS_Image_Classification_Lithology_Complete.csv']
    ...
    if args.continue_training:
        continue_, b, c = Recover_hyperparameters_GM(args.tracking_files_path + "General_tracking_LT_Complete.txt", b, c)
...
for i in range(len(Schedule)):
    t = open(args.tracking_files_path + "General_tracking_LT_Complete.txt", "a")
