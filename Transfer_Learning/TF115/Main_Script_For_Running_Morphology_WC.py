...
if args.phase == 'train':
    ...
    CSV_FILES_NAMES_TRAIN = ['OTUS_Image_Classification_F1_Morphology_WC.csv', 'OTUS_Image_Classification_F2_Morphology_WC.csv','OTUS_Image_Classification_F3_Morphology_WC.csv']
    CSV_FILES_NAMES_TEST  = ['OTUS_Image_Classification_F1_Morphology_WC.csv', 'OTUS_Image_Classification_F2_Morphology_WC.csv','OTUS_Image_Classification_F3_Morphology_WC.csv']
