...
if args.phase == 'train':
    ...
    CSV_FILES_NAMES_TRAIN = ['1OTUS_Image_Classification_TRAIN_Shells_White_fragments_MS.csv']#,'1OTUS_Image_Classification_TRAIN_Shells_White_fragments_MS.csv','1OTUS_Image_Classification_TRAIN_Lithology_WC.csv','1OTUS_Image_Classification_TRAIN_Shells_White_fragments_WC.csv']
    CSV_FILES_NAMES_TEST = ['1OTUS_Image_Classification_TEST_Shells_White_fragments_WC.csv']#,'1OTUS_Image_Classification_TEST_Shells_White_fragments_WC.csv','1OTUS_Image_Classification_TEST_Lithology_MS.csv','1OTUS_Image_Classification_TEST_Shells_White_fragments_MS.csv']
    ...
    for backbone_name in BACKBONE_NAME:
        ...
        for c in range(len(CSV_FILES_NAMES_TRAIN)):
            ...
            #                "--weights_definition automatic --learning_ratedecay True --lr 0.0001 --batch_size 5 --epochs 100 --patience 10 --runs 10 --phase train --optimizer Adam --feature_representation True --layer_index " + layer_position + " "
