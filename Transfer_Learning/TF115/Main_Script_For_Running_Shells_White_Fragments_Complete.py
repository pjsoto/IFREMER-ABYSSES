...
if args.phase == 'train':
    ...
    CSV_FILES_NAMES_TRAIN = ['OTUS_Image_Classification_Shells_White_fragments_Complete.csv']
    DATASET_MAIN_PATH_TRAIN = ['/datawork/DATA/']
    ...
    if args.continue_training:
        continue_, b, c = Recover_hyperparameters_GM(args.tracking_files_path + "General_tracking_SW_Complete.txt", b, c)
...
for i in range(len(Schedule)):
    t = open(args.tracking_files_path + "General_tracking_SW_Complete.txt", "a")
