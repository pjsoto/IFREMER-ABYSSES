...
parser.add_argument('--weights_definition', dest='weights_definition', type=str, default = 'manual', help='users can chosse between automatic|manual for the way the weights will be obtained')
