...
if args.phase == 'train':
    ...
    CSV_FILES_NAMES_TRAIN = ['OTUS_Image_Classification_F1_Lithology_ET.csv', 'OTUS_Image_Classification_F2_Lithology_ET.csv','OTUS_Image_Classification_F3_Lithology_ET.csv']
    CSV_FILES_NAMES_TEST  = ['OTUS_Image_Classification_F1_Lithology_ET.csv', 'OTUS_Image_Classification_F2_Lithology_ET.csv','OTUS_Image_Classification_F3_Lithology_ET.csv']
