...
if args.phase == 'train':
    ...
    CSV_FILES_NAMES_TRAIN = ['OTUS_Image_Classification_F1_Morphology_AllSets.csv', 'OTUS_Image_Classification_F2_Morphology_AllSets.csv','OTUS_Image_Classification_F3_Morphology_AllSets.csv']
    CSV_FILES_NAMES_TEST  = ['OTUS_Image_Classification_F1_Morphology_AllSets.csv', 'OTUS_Image_Classification_F2_Morphology_AllSets.csv','OTUS_Image_Classification_F3_Morphology_AllSets.csv']
    ...
    if args.continue_training:
        continue_, b, c = Recover_hyperparameters_GM(args.tracking_files_path + "General_tracking_PM_AllSets.txt", b, c)
...
for i in range(len(Schedule)):
    t = open(args.tracking_files_path + "General_tracking_PM_AllSets.txt", "a")
