...
if args.phase == 'train':
    ...
    if not args.cross_domain:
        ...
        CSV_FILES_NAMES_TEST  = ['OTUS_Image_Classification_F1_Lithology_MS_Ltd.csv', 'OTUS_Image_Classification_F2_Lithology_MS_Ltd.csv','OTUS_Image_Classification_F3_Lithology_MS_Ltd.csv']
        ...
        CSV_FILES_NAMES_TRAIN = ['OTUS_Image_Classification_F1_Lithology_MS_Ltd.csv', 'OTUS_Image_Classification_F2_Lithology_MS_Ltd.csv','OTUS_Image_Classification_F3_Lithology_MS_Ltd.csv', 'OTUS_Image_Classification_F1_Lithology_MS_Ltd.csv', 'OTUS_Image_Classification_F2_Lithology_MS_Ltd.csv','OTUS_Image_Classification_F3_Lithology_MS_Ltd.csv']
        CSV_FILES_NAMES_TEST  = ['OTUS_Image_Classification_F1_Lithology_WC_Ltd.csv', 'OTUS_Image_Classification_F2_Lithology_WC_Ltd.csv','OTUS_Image_Classification_F3_Lithology_WC_Ltd.csv', 'OTUS_Image_Classification_F1_Lithology_ET_Ltd.csv', 'OTUS_Image_Classification_F2_Lithology_ET_Ltd.csv','OTUS_Image_Classification_F3_Lithology_ET_Ltd.csv']
    ...
    while b < len(BACKBONE_NAME):
        ...
        while c < len(CSV_FILES_NAMES_TRAIN):
            ...
            Schedule.append("python " + Train_MAIN_COMMAND + " --train_task Image_Classification --learning_model CNN --backbone_name " + backbone_name + " --pretrained_backbone False --labels_type onehot_labels "
                            "--weights_definition automatic --learning_ratedecay True --lr 0.0001 --batch_size 5 --epochs 100 --patience 10 --runs 1 --phase train --tracking_training " + str(args.tracking_training) + " --continue_training " + str(continue_training) + " --identifier Lithology_MS --optimizer Adam --feature_representation True --layer_index " + layer_position + " "
