...
if args.phase == 'Train':
    ...
    if args.running_in == 'Datarmor_Interactive':
        Schedule.append("python TrainLearningModel.py --train_task Image_Classification --learning_model CNN --backbone_name vgg16 "
                        "--crop_size_rows 1024 --crop_size_cols 1024 --labels_type multiple_labels --learning_ratedecay True --lr 0.001 --gamma 2.0 --alpha 4.0 --optimizer Adam --batch_size 2 --runs 1 "
