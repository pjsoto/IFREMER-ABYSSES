...
if args.phase == 'Test':
    if args.running_in == 'Local_Anaconda_Environment':
        Schedule.append("python TestLearningModel.py --phase test "
                        "--train_task Image_Classification --learning_model CNN --backbone_name movilenet --train_dataset_name OTUSIFREMER_IMAGELABEL --checkpoint_name MovileNet/MONT_F3 "
                        ...
                        "--test_dataset_name OTUSIFREMER_IMAGELABEL --csvfile_name OTUS_Image_Classification_F3.csv --class_grouping False "
                        "--results_main_path D:/DATA/Pedro_Work/IFREMER_Work/CODE/IFREMER-ABYSSES-results/ --results_name MONT_F3 "
